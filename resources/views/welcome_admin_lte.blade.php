          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{asset('adminlte/index2.html')}}" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Dashboard v2</p>
                  </a>
                </li>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table m-0">
                      ...
                      <tbody>
                        <tr>
                          <td><a href="{{ asset('adminlte/pages/examples/invoice.html')}}">OR9842</a>
                          </td>
                        ...
                        <tr>
                          <td><a href="{{ asset('adminlte/pages/examples/invoice.html')}}">OR1848</a>
                          </td>
                        ...
                        <tr>
                          <td><a href="{{ asset('adminlte/pages/examples/invoice.html')}}">OR7429</a>
                          </td>
                          <td>iPhone 6 Plus</td>
